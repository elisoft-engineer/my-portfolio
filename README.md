# Elkana Maina | Software Engineer
...
I don't just "build websites"—I engineer digital systems. This portfolio is built with:
* **Operational Visibility:** Real-time system health indicators.
* **Dynamic Metadata:** Automated OG image generation using Next.js Edge Runtime.
* **Scalable UI:** Modular SCSS with custom design tokens and glassmorphism.
* **CI/CD Excellence:** Independent build pipelines using manual Deploy Hooks to bypass environment conflicts.
